...
@NamedQueries({
    ...
    , @NamedQuery(name = "Cliente.findByIdveichulo", query = "SELECT c FROM Cliente c WHERE c.idveichulo = :idveichulo")})
public class Cliente implements Serializable {
    ...
    @Size(max = 45)
    @Column(name = "idveichulo")
    private String idveichulo;

    public Cliente() {
    }

    public Cliente(Integer idcliente, String nombre, String apellido, String cedula, String direccion, String edad, String provinciaProcedencia, String idveichulo) {
    ...
    public String getIdveichulo() {
        return idveichulo;
    }

    public void setIdveichulo(String idveichulo) {
        this.idveichulo = idveichulo;
    }
